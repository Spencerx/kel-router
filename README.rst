...
.. image:: https://img.shields.io/travis/kelproject/router.svg
   :target: https://travis-ci.org/kelproject/router

.. image:: https://img.shields.io/badge/license-apache-blue.svg


HTTP/TLS reverse proxy in Go. It is a part of the Kel Project.
